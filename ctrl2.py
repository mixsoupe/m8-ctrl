...
while (True):
    ...
    if pressed7 and state7 == False:
        ...
        state7 = True   
    if button1.is_pressed and state8==False:
        keyboard.press(Key.media_volume_up)
        state8 = True
    if button2.is_pressed and state9==False:
        keyboard.press(Key.media_volume_down)
        state9 = True        
    if button1.is_pressed and button2.is_pressed and state89 == False:
        keyboard.press(Key.alt)
        keyboard.press(Key.enter)
        keyboard.release(Key.alt)
        keyboard.release(Key.enter)
    ...
    if not pressed7 and state7 == True:
        keyboard.release('a')
        state7 = False
    if not button1.is_pressed  and state8 == True:
        keyboard.release(Key.media_volume_up)
        state8 = False
    if not button2.is_pressed and state9 == True:
        keyboard.release(Key.media_volume_down)
        state9 = False
